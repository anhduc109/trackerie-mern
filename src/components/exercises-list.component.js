...
export default class ExerciseList extends Component {
  ...
  componentDidMount() {
    ...
    axios
      .get("https://mern-trackerie.herokuapp.com:80/exercises/")
      .then(res => {
    ...
    axios
      .get("https://mern-trackerie.herokuapp.com:80/users/")
      .then(res => {
  ...
  deleteExercise(id) {
    ...
    if (answer) {
      axios
        .delete("https://mern-trackerie.herokuapp.com:80/exercises/" + id)
