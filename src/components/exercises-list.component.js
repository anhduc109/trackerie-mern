...
export default class ExerciseList extends Component {
  ...
  componentDidMount() {
    ...
    axios
      .get("http://mern-trackerie.herokuapp.com:80/exercises/")
      .then(res => {
    ...
    axios
      .get("http://mern-trackerie.herokuapp.com:80/users/")
      .then(res => {
  ...
  deleteExercise(id) {
    ...
    if (answer) {
      axios
        .delete("http://mern-trackerie.herokuapp.com:80/exercises/" + id)
